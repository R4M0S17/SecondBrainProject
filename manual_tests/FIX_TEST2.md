# FIX_TEST2 — Remediation plan for `manual_tests/test2.md`

> **Audience**: engineers fixing Cerebro chat quality on local llama.cpp (Qwen3-4B session, 2026-05-16).  
> **Companion**: extends `FIX_PLAN2.md` (test_1 regressions). Many steps there are **already merged**; this doc covers **what test_2 still proves is broken** and how to close it with minimal, high-leverage changes.
...
From `FIX_PLAN2.md` — confirmed in tree as of test2 session:
