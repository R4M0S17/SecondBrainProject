...
4. Compare with `manual_tests/test2.md` and `manual_tests/FIX_TEST2.md` — same **RC-PARSE** pattern on calendar queries.
...
- `manual_tests/test_1.md` — earlier session (different model)
- `manual_tests/test2.md` / `manual_tests/FIX_TEST2.md` — Qwen3 parse failures and remediation plan
- `pruebas_chat_manual.md` — if present at repo root, may overlap
