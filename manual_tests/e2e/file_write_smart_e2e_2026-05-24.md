...
Mejora pedida en `manual_tests/sessions/frontend_chat_qwen3_2026-05-24.md` (ítem 4): no guardar literalmente descripciones ni bloques markdown con fences.
...
- `manual_tests/e2e/file_write_fast_path_e2e_2026-05-24.md` — fast path básico (confirmación)
- `manual_tests/e2e/calendar_file_export_fusion_2026-05-25.md` — export cumpleaños/eventos del calendario a archivo (**DONE**)
- `manual_tests/sessions/frontend_chat_qwen3_2026-05-24.md` — sesión manual original
