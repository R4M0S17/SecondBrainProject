...
- [`diagnosis_frontend_chat_qwen3_2026-05-21.md`](../diagnoses/diagnosis_frontend_chat_qwen3_2026-05-21.md) — Problem A (hallucinated file creates)
- [`FIX_TEST2.md`](fix-plan-test2.md) — H3.3 file-write micro-route
